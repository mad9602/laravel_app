                    ...
                    <form method="POST" action="{{ route('teams.update',Auth::id()) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <select class="custom-select col-md-6 ml-3 @error('team') is-invalid @enderror" name="team">
                                <option value="{{$user['team']}}" selected>{{\Team::LIST[$user['team']]}}</option>
                        ...
                        <div class="form-group row">
                            ...
                            <select class="custom-select col-md-6 ml-3 @error('area') is-invalid @enderror" name="area">
                                <option value="{{$user['area']}}" selected>{{\Area::LIST[$user['area']]}}</option>
                        ...
                        <div class=" form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="body" type="text" class="form-control @error('body') is-invalid @enderror " name="body" value="{{ $user['body'] }}" required>
